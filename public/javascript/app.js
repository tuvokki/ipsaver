...
app.directive("ipList", function() {
  return {
    template: '<div class="wrap head"> <div class="col1of4"> <span>Ip:</span> </div> <div class="col1of4"> <span>Comment:</span> </div> <div class="col1of4"> <span>Host:</span> </div> <div class="col1of4"> <span>Date:</span> </div> </div> <div class="wrap data"> <div ng-repeat="iprecord in iplist" class="record"> <div class="col1of4"> {{ iprecord.ip }} </div> <div class="col1of4"> {{ iprecord.msg }} </div> <div class="col1of4"> {{ iprecord.host }} </div> <div class="col1of4"> {{ iprecord.date | date : "MM/dd/yyyy h:mma" }} </div> </div> </div>'
  };
});
